...
Constitution: v2.0.1. Principle IV: satellite system is agent-platform-agnostic via the `AgentPlatform` plugin seam — feature 013 extends the seam to the deploy layer with `SetupCapability`.
<!-- SPECKIT END -->
