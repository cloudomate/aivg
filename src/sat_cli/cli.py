"""``sat-cli`` Typer app — entry point ``sat-cli`` (see ``pyproject.toml``).
...
app = typer.Typer(
    name="sat-cli",
    help="Satellite management CLI — platform-neutral (feature 011, "
    "constitution v2.0.0). Speaks the App. A REST surface; ships per-platform "
    "skills alongside.",
